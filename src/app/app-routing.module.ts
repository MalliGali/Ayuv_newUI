...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'patientSingleMessage/compose/:id', component: ComposeSingleMessageComponent, data: { extraParameter: 'patientSingleMessage/compose/:id' } },
      ...
      { path: 'patientScheduleMessage/compose/:id', component: ScheduleMessageSentComponent, data: { extraParameter: 'patientScheduleMessage/compose/:id' } },
