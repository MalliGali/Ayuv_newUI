...
import { CreateSingleMessageComponent } from './Pages/MainPages/create-single-message/create-single-message.component';
...
import { SingleMessageSentComponent } from './Pages/MainPages/single-message-sent/single-message-sent.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'dashboard/smsSingle', component: SingleMessageSentComponent, data: {extraParameter: 'pagesMenu'}},
      {path: 'dashboard/smsSchedule', component: ScheduleMessageSentComponent, data: {extraParameter: 'pagesMenu'}},
